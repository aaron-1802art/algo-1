  ...
  return (
    <footer className="relative bg-neutral-950 text-white overflow-hidden pt-24 pb-12">
      ...
      <div className="absolute inset-0 opacity-30">
        <img 
          src="https://images.unsplash.com/photo-1511497584788-876760111969?q=80&w=3500&auto=format&fit=crop" 
          alt="Dark forest"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-5">
              <div className="flex items-center gap-2 mb-6">
                <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-green-600 to-emerald-300" />
                <span className="font-outfit font-semibold text-xl tracking-tight text-white">GreenMotive</span>
              </div>
              <p className="text-white/60 mb-8 max-w-sm">
                Designing the future of natural harmony. We exist at the intersection of high-end architectural design and sustainable ecological practice.
              </p>
              ...
              <form onSubmit={handleSubscribe} className="relative max-w-sm">
                ...
                {subscribed && (
                  <span className="absolute -bottom-6 left-4 text-xs text-emerald-400">Subscribed successfully! ✅</span>
                )}
              </form>
            </div>
            ...
            <div className="md:col-span-3 md:col-start-8">
              ...
              <ul className="space-y-4 text-white/60">
                <li><a href="#" className="hover:text-white transition-colors">Eco-Urban Development</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Renewable Energy</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Ocean Restoration</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Conservation Tech</a></li>
              </ul>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-white/40 text-sm">
          <p>© {new Date().getFullYear()} GreenMotive. All rights reserved.</p>
